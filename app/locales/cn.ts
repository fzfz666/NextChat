...
const cn = {
  ...
  Auth: {
    ...
    TopTips:
      "🥳 输入密码，立刻解锁 gemini-2.5, DeepSeek-R1，Claude-3.7 等最新大模型",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Mask: {
      Splash: {
        Title: "prompt模板启动页",
        SubTitle: "新建聊天时，展示prompt模板启动页",
      },
      Builtin: {
        Title: "隐藏内置prompt模板",
        SubTitle: "在所有prompt模板列表中隐藏内置prompt模板",
      },
    },
    Prompt: {
      Disable: {
  ...
  NewChat: {
    ...
    Title: "挑选一个Prompt",
    SubTitle: "现在开始，与Prompt背后的灵魂思维碰撞",
    More: "查看全部",
  },
